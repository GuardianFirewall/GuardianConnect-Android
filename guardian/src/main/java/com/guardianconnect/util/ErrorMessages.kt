...
object ErrorMessages {
    ...
    fun getBadConfigExceptionExplanation(
        resources: Resources,
    ...
    fun getBadConfigExceptionReason(
        resources: Resources,
        bce: BadConfigException
    ): String {
        if (bce.cause is KeyFormatException) {
