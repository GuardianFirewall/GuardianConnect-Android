...
data class SubscriberCredentialsJSON(
    ...
    override fun toString(): String {
        return "SubscriberCredentialsJSON(subscriptionType=$subscriptionType," +
                " subscriptionTypePretty=$subscriptionTypePretty," +
                " subscriptionExpirationDate=$subscriptionExpirationDate, exp=$exp, iat=$iat)"
    }
}